			...
			<div class="container">
				<div class="pull-left auto-width-left">
					<ul class="top-menu menu-beta l-inline">
						<li><a href=""><i class="fa fa-home"></i> 62/4b Tân Tiến, Xã Xuân Thới Đông, HM, TP.HCM</a></li>
						<li><a href=""><i class="fa fa-phone"></i> 0393 686 894</a></li>
					</ul>
				</div>
		...
		<div class="header-body">
			<div class="container beta-relative">
				...
				<div class="pull-right beta-components space-left ov">
					...
					<div class="beta-comp">
						<form role="search" method="get" id="searchform" action="{{ route('SearchProduct') }}">
								...
								<div class="beta-dropdown cart-body">
									...
									@foreach($cart->items as $product)
										...
										<div class="cart-item">
											...
											<a href="{{ route('DeleteOneProductToCart',$product['item']['id']) }}" class="cart-item-delete" style="color: red;"><b>X</b></a>
											<div class="media p-0">
												...
												<div class="media-body">
													...
													<span class="cart-item-amount">{{ $product['qty'] }} x 
														<span class="mr-5"> {{ number_format($product['price'],0,",",".") }}</span>
														Thành tiền:
														<span> {{ number_format($product['totalprice'],0,",",".") }}</span>
													</span>
												</div>
											</div>
										</div>
